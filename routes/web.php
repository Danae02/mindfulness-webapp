...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Research settings (bestaande routes, ongewijzigd)
    ...
    // ===== NIEUWE ROUTES VOOR STANDAARDVRAGEN =====
    // Routes voor het beheren van de standaardvraag (voor gebruikers zonder groep)
