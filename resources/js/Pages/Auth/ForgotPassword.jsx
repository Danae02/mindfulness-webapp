        ...
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                <div className="flex justify-start mb-2">
                    <Link
                        href={route('login')}
                        className="inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-[#6c4092] hover:bg-[#5a337a] rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[#6c4092] focus:ring-offset-2"
                    >
                ...
                <div
                    className="mb-3 text-sm text-gray-800 bg-gray-50 p-2 sm:p-3 rounded-lg border-2 border-gray-600"
                    role="note"
                >
                    <p>
