    ...
    return (
        ...
        >
            ...
            <Link
                ...
                className="flex-shrink-0 inline-flex items-center gap-2 px-3 py-2 bg-[#7B5EA7] text-white text-sm font-semibold
            ...
            >
                ...
                <span className="hidden sm:inline" aria-hidden="true">Start</span>
            </Link>
            ...
            {auth.user && (
                <button
                    ...
                    className="flex-shrink-0 inline-flex items-center gap-2 px-3 py-2 rounded-lg transition-colors
                        focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#7B5EA7]"
                    style={{
                ...
                >
                    ...
                    <span className="hidden sm:inline text-sm font-medium" aria-hidden="true">
                        Favoriet
                    </span>
                </button>
            )}
